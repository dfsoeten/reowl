<template>
  <div class="match-list">
    <template v-if="matchesData.length > 0">
    ...
    <template v-else>
      <div class="match-list__match-group">
        <h3 class="match-list__match-group-title">
          {{ $t('miscellaneous.loading') }}...
        </h3>
        <div class="match-list__match-group-content">
          <b-row>
            <b-col v-for="index in 9" :key="index" sm="6" lg="4">
...
import MatchCardPlaceholder from '~/components/MatchCardPlaceholder/MatchCardPlaceholder.vue'
import { groupMatches } from '~/utils/match'

@Component({ components: { MatchCard, MatchCardPlaceholder } })
